...
public class ResourceSpecifier : MonoBehaviour
{
    ...
    [SerializeField] private ResourceSpawnManager resourceSpawnManager;
    [SerializeField] private ResourceUI UImanager;
    [SerializeField] private ResourceStatsManager resourceStatsManager;
   ...
   //0. option of building and setting which building is chosen
    public void BarrackIsChoosen(){
        ...
        UImanager.woodCost=CostData.woodCost;
        UImanager.grainCost=CostData.grainCost;
        UImanager.stoneCost=CostData.stoneCost;
